...
if __name__ == '__main__':
    ...
    """ 
        ...
        Predict [1, 7] days in ARIMA
    """
    # experiment_name = "Experiment_1_Predict_1_and_7_days_in_ARIMA"
    # experiment_id = 1
    # output_window_size = [1, 7]  # always a list [7, 14, 30, 60]
    # p_range = range(0, 3)  # list of possible p paramaters, range(0, 10)
    # q_range = range(0, 3)  # list of possible q paramaters, range(0, 10)
    # P_VALUE_PERCENT = '5%'
    ...
    """ 
       Experiment 2
       Predict 7 days in LSTM
    """
    # experiment_name = "Experiment_2_Predict_7_days_LSTM"
    # experiment_id = 2
    ...
    # shift = 7
    #
    # X_train, X_test, Y_train, Y_test, normalization_arrays, n_features = SampleGenerator(
    ...
    """
    # experiment_name = "Experiment_3_Predict_1_day_LSTM"
    # experiment_id = 3
    # architecture_name = "2xLSTM"
    # use_log = False
    # input_averaging = False
    ...
    """ 
       LIVE DEMO - 7 days in ARIMA
    """
    experiment_name = "Experiment_4_Predict_7_days_in_ARIMA"
    experiment_id = 4
    output_window_size = [7]  # always a list [7, 14, 30, 60]
    p_range = range(0, 3)  # list of possible p paramaters, range(0, 10)
    q_range = range(0, 3)  # list of possible q paramaters, range(0, 10)
    P_VALUE_PERCENT = '5%'
    # ARIMASeriesGenerator(
